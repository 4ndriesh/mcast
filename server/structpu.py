...
class StructPU():
    ...
    def unpack_Ttssrvcmd_Data(self, TDatagram2):
        Head_TDatagram2 = self.Ttssrvcmd_Data._make(
            self.struct_unpack_Ttssrvcmd_Data(TDatagram2[self.struct_len_TDatagram2:]))
        return Head_TDatagram2
    ...
    def pack_TDatagram2(self, **kwargs):
        ...
        struct_pack_Data_TDatagram2 = struct.Struct(
            struct_fmt_Ttssrvcmd_Data2.format(kwargs['size_datagram2_data'])).pack
        TDatagram2 = struct_pack_Data_TDatagram2(kwargs['size_datagram2_data'], 1, kwargs['channel_name'],
                                                 *kwargs['ts_array'])
        print(TDatagram2)
        return TDatagram2
